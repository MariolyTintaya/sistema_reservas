...
<body class="bg-gray-100 flex flex-col">
            ...
            <div class="sidebar-content">
                <nav class="mt-6">
                    <ul>
                        ...
                        <li>
                            <button id="toggleEmpleado" class="block w-100 py-3 px-4 text-white font-bold text-start btn btn-link btn-destino">
                                Empleado
                            </button>
                            <div id="empleadoMenu" class="d-none">
                                <ul class="list-unstyled ps-4">
                                  <li><a href="{{ route('vendedores.index') }}" class="text-white text-decoration-none">Empleados</a></li>
                                  <li><a href="{{ route('vendedores.create') }}" class="text-white text-decoration-none">Nuevo Empleado</a></li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <button id="toggleCliente" class="block w-100 py-3 px-4 text-white font-bold text-start btn btn-link btn-destino">
                                Cliente
                            </button>
                            <div id="clienteMenu" class="d-none">
                                <ul class="list-unstyled ps-4">
                                  <li><a href="#" class="text-white text-decoration-none">Clientes</a></li>
                                  <li><a href="#" class="text-white text-decoration-none">Modificar un Cliente</a></li>
                                  <li><a href="#" class="text-white text-decoration-none">Modificar un Deposito</a></li>
                                  <li><a href="#" class="text-white text-decoration-none">Modificar un Pago</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        document.getElementById('toggleCliente').addEventListener('click', function () {
            const clienteMenu = document.getElementById('clienteMenu');
            clienteMenu.classList.toggle('d-none');
        });
    </script>
</body>
